...
@section('title','TelPri-Web | Lineas Cisco')
@section('contenido')
...
<div class="d-flex">
    ...
    <h2 class="align-middle">Líneas Telefónicas Cisco.</h2>
</div>
...
<div class="d-flex justify-content-between">
    ...
    <div class="d-flex">
        ...
        @endcan
        <a href="{{ url('lineas/pdf-cisco') }}" class="btn btn-outline-light btn-sm " target="_blank">
