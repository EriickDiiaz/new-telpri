...
@section('title','TelPri-Web | Lineas Ericsson')
@section('contenido')
...
<div class="d-flex">
    ...
    <h2 class="align-middle">Líneas Telefónicas Ericsson.</h2>
</div>
...
<div class="d-flex justify-content-between">
    ...
    <div class="d-flex">
        ...
        @endcan
        <a href="{{ url('lineas/pdf-ericsson') }}" class="btn btn-outline-light btn-sm " target="_blank">
